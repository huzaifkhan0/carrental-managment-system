...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>">BrandName:<?php echo htmlentities($result->BrandName);?><br> VehicleName:<?php echo htmlentities($result->VehiclesTitle);?></a></h5>
